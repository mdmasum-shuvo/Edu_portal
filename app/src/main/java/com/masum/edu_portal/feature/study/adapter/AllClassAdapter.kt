...
import com.masum.edu_portal.databinding.ItemAllLectureBinding
...
class AllClassAdapter constructor(val context: Context?, val list: List<Datum>?) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val memberBinding: ItemAllLectureBinding = DataBindingUtil.inflate(
            LayoutInflater.from(context),
            R.layout.item_all_lecture,
            parent,
            false
        )
    ...
    internal class MemberListViewHolder(itemBinding: ItemAllLectureBinding) :
        RecyclerView.ViewHolder(itemBinding.root) {
        val binding: ItemAllLectureBinding
