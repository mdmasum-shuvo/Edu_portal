...
import com.masum.edu_portal.databinding.ItemOfficialBinding
import com.masum.edu_portal.databinding.SeeAllViewBinding
import com.masum.edu_portal.feature.member.data.official.Datum

class AcademyOfficialAdapter constructor(val context: Context?, val list: List<Datum>?) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val memberBinding: ItemOfficialBinding = DataBindingUtil.inflate(
            LayoutInflater.from(context),
    ...
    internal class SeeAllViewHolder(itemBinding: SeeAllViewBinding) :
        ...
        fun bindView() {
            ...
            binding.tvTextSeeAll.setText(itemView.context.resources.getString(R.string.see_all_official))
        }
    }

    internal class MemberListViewHolder(itemBinding: ItemOfficialBinding) :
        RecyclerView.ViewHolder(itemBinding.root) {
        val binding: ItemOfficialBinding
