...
class MemberListAdapter constructor(val context: Context, val list: List<Datum>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val memberBinding: ItemMemberBinding = DataBindingUtil.inflate(
            LayoutInflater.from(context),
    ...
    internal class SeeAllViewHolder(itemBinding: SeeAllViewBinding) :
        ...
        fun bindView() {
            ...
            binding.tvTextSeeAll.setText(itemView.context.resources.getString(R.string.see_all_member))
        }
    }

    internal class MemberListViewHolder(itemBinding: ItemMemberBinding) :
        RecyclerView.ViewHolder(itemBinding.root) {
