...
import com.masum.edu_portal.databinding.ItemVideoLectureBinding
import com.masum.edu_portal.databinding.SeeAllViewBinding
import com.masum.edu_portal.feature.study.data.all_study.Datum

class AllVideoLectureAdapter constructor(val context: Context?, val list: List<Datum>?) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val memberBinding: ItemVideoLectureBinding = DataBindingUtil.inflate(
            LayoutInflater.from(context),
            R.layout.item_video_lecture,
            parent,
            false
        )
    ...
    internal class SeeAllViewHolder(itemBinding: SeeAllViewBinding) :
        ...
        fun bindView() {
            ...
            binding.tvTextSeeAll.setText(itemView.context.resources.getString(R.string.see_all_lecture))
        }
    }

    internal class MemberListViewHolder(itemBinding: ItemVideoLectureBinding) :
        RecyclerView.ViewHolder(itemBinding.root) {
        val binding: ItemVideoLectureBinding
